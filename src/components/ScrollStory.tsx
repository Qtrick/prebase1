...
const CHAPTERS: Array<{
...
}> = [
  {
    ...
    body: "Repositories are connected systems. PreBase maps the whole repository instead of asking you to reconstruct it from a file tree.",
  },
  {
    n: "02",
    nav: "Relationships",
    ...
    body: "Dependencies, clusters, and the paths between them — walked from real imports, not guessed.",
  },
  {
    n: "03",
    nav: "Context",
    group: "network",
    title: "Turn relationships into context.",
    body: "Select a file and its connected modules become Agent context. Ask, edit, or hand the whole neighbourhood to an agent.",
  },
  {
    n: "04",
    nav: "History",
    ...
    body: "PreBase turns Git history into structural snapshots. Move through commits to see files and relationships added, removed, modified, and renamed while the rest of the codebase stays spatially recognizable.",
  },
  {
    n: "05",
    nav: "Change",
    group: "temporal",
    title: "Follow structural change.",
    body: "Instead of reading a commit list and reconstructing the impact yourself, watch the architecture evolve and see exactly where each change happened.",
  },
];
  ...
  return (
    <section id="product" ref={ref} className="relative mt-16 h-[520vh] sm:mt-20 lg:h-[620vh]">
      <div className="sticky top-16 flex h-[calc(100svh-5rem)] flex-col justify-center lg:top-20 lg:h-[calc(100vh-6rem)]">
        <div className="mx-auto grid w-full max-w-[1240px] gap-4 px-5 sm:px-8 lg:grid-cols-[minmax(0,1fr)_260px] lg:items-center lg:gap-10 lg:pr-10 xl:pl-[176px]">
          {/* product canvas */}
          <motion.div
